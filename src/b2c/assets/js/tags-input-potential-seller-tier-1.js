...
(function ($) {
	...
	$.fn.tagsInput = function (options) {
		...
		this.each(function () {
			...
			var markup = $("<div>", { id: id + "_tagsinput", class: "tagsinput" }).append($("<div>", { id: id + "_addTag" }).append(settings.interactive ? $("<input>", { id: id + "_tag", class: "tag-input", value: "", placeholder: settings.placeholder }) : null));
